    ...
    <el-card class="box-card">
      <div class="block">
        ...
        >
          ...
          <el-table-column prop="grade" label="分数" width="60" align="center"> </el-table-column>
...
export default {
  ...
  methods: {
    ...
    async exportExcel() {
      this.$message.success('正在批量下载，请勿操作页面（此过程耗时大约两分钟）')
      ...
      for (let i = 0; i < mark; i++) {
        if (this.tableData[i].postate == 2 && this.tableData[i].state == 2) {
          ...
          //   fileUrl = {
          //     fileUrl:
          //       "http://120.55.71.155/api/experiment/pdf8?student_id=" +
          //       this.tableData[i].id,
          //     renameFileName:
          //       this.tableData[i].student_class +
          //       "-" +
    ...
    async dialogs1() {
      if (this.form.fraction_p2 && this.form.fraction_p2 != "") {
        const { data: res } = await this.$http.post(
    ...
    async daochu(id) {
      ...
      if (this.form.experiment_name == "欧姆表的改装设计") {
        ...
        window.location.href =
          "http://180.76.111.200/api/experiment/pdf8?student_id=" +
          this.student_id;
      } else if (this.form.experiment_name == "万用表改装设计实验") {
        window.location.href =
          "http://180.76.111.200/api/experiment11/pdf11?student_id=" +
        ...
        window.location.href =
          "http://180.76.111.200/api/bridge1/pdf5?student_id=" + this.student_id;
      } else if (this.form.experiment_name == "示波器的调整与使用") {
        window.location.href =
          "http://180.76.111.200/api/experiment14/pdf14?student_id=" +
          this.student_id;
